...
class MailSend:
    ...
    def show_options(self):
        options = f"""
            ...
            | To   :                |  {self.target}                           |
            | Mail Server :         |  {self.server_name}                                     |
            | Mail Server Port :    |  {self.port}                                                |
            | Message Amount   :    |  {self.amount_message}                                                |
            | Attack Start Time :   |  {self.attack_start_time}                                 |
            |_ _ _ _ _ _ _ _ _ _ _ _|_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _|
        """
        print(options)
...
if __name__ == '__main__':
    warning = input('Bu Programın Çalışması İçin Gmail Hesabınızdan Daha az\nGüvenli Uygulamalara İzin Vermelisiniz....')
    if not warning or warning:
        mail = MailSend()
        mail.config_server_name()
        mail.mail_send_count()
        mail.send_config()
        mail.attack()